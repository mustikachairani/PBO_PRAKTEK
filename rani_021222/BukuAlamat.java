            ...
            while (pil != 5) {
                ...
                switch (pil) {
                    case 1 : 
                        ...
                        input.setName(dataIn.readLine());
                        System.out.println(" Alamat Lengkap  : ");
                        input.setAddress(dataIn.readLine());
                        System.out.println(" Nomor Telepon   : ");
                        input.setTelepon(dataIn.readLine());
                    ...
                    case 3:
                        for(int i=0; i<idx; i++)
                        {
                            ...
                            System.out.println("Nama Lengkap    :" + dba[i].getName());
                            System.out.println("Alamat Lengkap  :" + dba[i].getAddress());
                            System.out.println("Nomor Telepon   :" + dba[i].getTelepon());
                    ...
                    case 4:
                        ...
                        System.out.println("Nama Lengkap    :");
                        dba[index].setName(dataIn.readLine());
                        System.out.println("Alamat Lengkap  :");
                        dba[index].setAddress(dataIn.readLine());
                        System.out.println("Nomor Telepon   :");
                        dba[index].setTelepon(dataIn.readLine());
                        System.out.println("Email           :");
